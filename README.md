# UCLA Connection Lab Bitcoin Observatory

This is a fork of [The Mempool Open Source Project®](https://github.com/mempool/mempool) customized with UCLA colors for display in the UCLA Connection Lab.

## Changes from Original

This fork also added:
- Animated transaction feed with flash effects
- Optimized layout for 24/7 display viewing
